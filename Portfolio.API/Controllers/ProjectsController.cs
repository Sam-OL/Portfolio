...
namespace Portfolio.API
{
    ...
    public class ProjectsController : ControllerBase
    {
        public static List<Projects> _projects = new List<Projects>() { 
            new Projects { Name = "Momentum", Date = new DateTime(2022, 03, 19), Color = "Dark Blue", Tag = "Game", LDescription = "", SDescription = "This is a racing game I made in my free-time as a learning project for the unity game engine", Link =  new Link { Text = "Click to view app", Url = "This is the url" } },
